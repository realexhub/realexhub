...
Every number above is measured on hardware I can name, and the method is in BENCHMARKS.md. What kern does not do yet is written down too, in OPEN_ITEMS.md.
